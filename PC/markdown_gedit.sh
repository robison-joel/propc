...
sudo apt-get install python3-markdown pandoc gir1.2-webkit2-4.0 git -y
...
cd gedit-plugin-markdown_preview || exit
...
sudo apt-get update ; apt-get list --upgradable ; sudo apt-get upgrade
