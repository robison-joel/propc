...
# =============================================================================================
# TITULO..: SCRIPT SUBLIME TEXT
# CONTEUDO: ShellScript que instala o SUBLIME TEXT no computador
...
VAR_LOG="logs/log_SUBLIME TEXT_$(date +%d-%m-%Y).log"
...
figlet "SUBLIME TEXT"  | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) |       ######################################      " | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) |    ############################################   " | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) | ##################################################" | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) | #########                                #########" | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) | ######                                      ######" | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) | ###                                            ###" | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) | ###    DESEJA INSTALAR AS SUBLIME TEXT?        ###" | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) | ###                                            ###" | sudo tee -a "$VAR_LOG"
...
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) |                                                   " | sudo tee -a "$VAR_LOG"
read -r "VAR_SUBLIMETEXT"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) |                                                   " | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) | Tu apertastes o numero: $VAR_SUBLIMETEXT" | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) |                                                   " | sudo tee -a "$VAR_LOG"
echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) | ##################################################" | sudo tee -a "$VAR_LOG"
#####
##### Condicional de instalação ########################
#####
if [ "$VAR_SUBLIMETEXT" = "3" ]; then
...
elif [ "$VAR_SUBLIMETEXT" = 1 ]; then

#############################################################################################
    
    ##### Instala o SUBLIME TEXT
    echo "# $(date +%d-%m-%y) ás $(date +%H:%M:%S) | ##### Instala o SUBLIME TEXT"  | sudo tee -a "$VAR_LOG"

    sudo mkdir .sublime_text
    
    cd .sublime_text/
    
    sudo wget https://download.sublimetext.com/sublime-text_build-3211_amd64.deb | sudo tee -a "$VAR_LOG"
    
    sudo chmod +x sublime-text_build-3211_amd64.deb | sudo tee -a "$VAR_LOG"
    
    sudo dpkg -i sublime-text_build-3211_amd64.deb | sudo tee -a "$VAR_LOG"
