...
echo "######                                      ######" | sudo tee -a "$VAR_LOG"
echo "###                                            ###" | sudo tee -a "$VAR_LOG"
echo "###   DESEJA INSTALAR AS SIMPLESCREENRECORDER? ###" | sudo tee -a "$VAR_LOG"
echo "###                                            ###" | sudo tee -a "$VAR_LOG"
...
echo "                                                  " | sudo tee -a "$VAR_LOG"
echo "Tu apertastes o numero: $VAR_SIMPLESCREENRECORDER" | sudo tee -a "$VAR_LOG"
echo "                                                  " | sudo tee -a "$VAR_LOG"
echo "##################################################" | sudo tee -a "$VAR_LOG"
#####
...
#############################################################################################
    ...
    echo "##### Instala o SIMPLESCREENRECORDER"  | sudo tee -a "$VAR_LOG"
